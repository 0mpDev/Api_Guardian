...
public class ApiKeyService {
     ...
     */
    public ApiKey generateApiKey(String userId,
                                 String name,
        ...
        ApiKey.RateLimitTier finalTier = tier != null ? tier : ApiKey.RateLimitTier.FREE;
        ...
        ApiKey apiKey = ApiKey.builder()
                ...
                .tier(finalTier)
                .requestsPerMinute(finalTier.getRequestsPerMinute())
                .requestsPerHour(finalTier.getRequestsPerHour())
                .requestsPerDay(finalTier.getRequestsPerDay())
                .requestsPerMonth(finalTier.getRequestsPerMonth())
                .totalRequests(0L)
        ...
        // IMPORTANT: Return the raw key ONLY once (user must save it)
        saved.setKeyValue(rawKey);

        log.info("Generated new API key for user: {}, tier: {}", userId, tier);
        return saved;
    }
